<#
.SYNOPSIS
    Script de publicación para laravel multitenencia.
.DESCRIPTION
...
Write-Host "  📦 Laravel Multitenencia - Script de Publicación" -ForegroundColor Magenta
Write-Host "═══════════════════════════════════════════════════════════════" -ForegroundColor Magenta
Write-Host ""
...
Write-Host "  Tag:     https://github.com/Edd-war/laravel-multitenencia/releases/tag/$newVersion" -ForegroundColor White
Write-Host ""
Write-Host "  Si están configurados, los workflows de GitHub Actions se ejecutarán automáticamente:" -ForegroundColor Gray
Write-Host "    • Release → Crear GitHub Release" -ForegroundColor Gray
Write-Host "    • Validación Composer → Validar paquete" -ForegroundColor Gray
Write-Host "    • Publicación Composer → Publicar en GitHub Packages" -ForegroundColor Gray
Write-Host ""
